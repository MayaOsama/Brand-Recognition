...
sys.path.append(os.path.join(os.path.dirname(__file__), "./models-master/research"))
sys.path.append(os.path.join(os.path.dirname(__file__), "./models-master/research/object_detection"))
sys.path.append(os.path.join(os.path.dirname(__file__), "./models-master/research/object_detection/legacy"))
sys.path.append(os.path.join(os.path.dirname(__file__), "./models-master/research/slim"))
